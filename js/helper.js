...
/*
    Note: the following variable is unused in the assignment template.  I've redefined the commented
    variables to use this variable to cut down on excess code.  -DN
*/
