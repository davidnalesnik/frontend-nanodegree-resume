...
var HTMLheaderRole = '<span class="coral-text">%data%</span><hr/>';
...
var HTMLskillsStart = '<h3 id="skills-h3" class="green-text">Skills at a Glance:</h3><ul id="skills" class="flex-box"></ul>';
